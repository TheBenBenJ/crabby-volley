...
function getSnapshot() {
  return {
    ...
    blobs: activeBlobs.map(b => ({
      ...
      animal: b.animal, molt: b.molt, hasBall: b.hasBall, tongueOut: b.tongueOut, scramble: b.scramble,
...
function applySnapshot(s) {
  ...
  activeBlobs.forEach((b, i) => {
    ...
    b.molt = s.blobs[i].molt || 0; b.hasBall = !!s.blobs[i].hasBall; b.tongueOut = !!s.blobs[i].tongueOut; b.scramble = s.blobs[i].scramble || 0;
